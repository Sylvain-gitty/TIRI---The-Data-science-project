...
![Total dataset by label](reports/eda_quickstart_1_total_by_label.png)
...
![Papers per use case by label](reports/eda_quickstart_2_use_cases_by_label.png)
...
![Missing-rate by feature and label](reports/eda_quickstart_3_missingness.png)
...
![Skew and outliers by use case](reports/eda_quickstart_4_skew_by_use_case.png)
...
![Embedding space, PCA-projected to 2D](reports/eda_quickstart_5_embeddings_pca.png)
