...
|---|---|---|
| **`main/`** | Two lines: the **10-notebook TIRI main line** (`01`–`10`), numbered in reading order — start here — and a parallel **4-notebook `*_benchset_v1` line** over the benchmark corpus, described in its own section below. | Yes — `01` and `04` of each line only |
